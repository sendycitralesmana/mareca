<div class="modal fade" id="edit-{{ $client->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form role="form" method="POST" action="/back-office/client/{{ $client->id }}/update" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text"  name="client" class="form-control @if($errors->has('client')) is-invalid @endif" value="{{ $client->client }}"
                                required oninput="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Klien harus diisi')">
                            ...
                            <div class="form-group">
                                ...
                                <input type="url"  name="link" class="form-control @if($errors->has('link')) is-invalid @endif" placeholder="Link" value="{{ $client->link }}">
                                @if($errors->has('link'))
                            ...
                            <div class="form-group">
                                ...
                                @if ($client->image)
                                    <img src="{{ Storage::disk('s3')->url($client->image) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block"
