            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        {{-- <a href="/back-office/user/{{ auth()->user()->id }}/edit-data" class="btn btn-tool btn-sm" title="Ubah Data">
                            <i class="fas fa-edit"></i>
                        </a>
                        <a href="/back-office/user/{{ auth()->user()->id }}/edit-password" class="btn btn-tool btn-sm" title="Ubah Password">
                        ...
                        @include('back-office.user-data.user.modal.edit-data')

                        <button class="btn btn-tool" data-toggle="modal" data-target="#edit-password-{{ $user->id }}" title="Ubah Password">
                            <i class="fa fa-lock"></i>
                        </button>

                        @include('back-office.user-data.user.modal.edit-password')
                ...
                <div class="card-body">
                    ...
                    <div class=" text-center">
                        ...
                        @else
                            <img src="{{ asset('images/no-image.png') }}" class="gambarPreviewuser img-fluid mb-3 d-block" alt=""
                            style="width: 150px; height: 150px; margin-left: auto; margin-right: auto">
                        @endif
                    </div>
                    <hr>
