<div class="modal fade" id="edit-data-{{ $user->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form role="form" method="POST" action="/back-office/user-data/user/{{ $user->id }}/update-data" enctype="multipart/form-data">
                {{ csrf_field() }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if ($user->foto)
                                            <img src="{{ Storage::disk('s3')->url($user->foto) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block"
                                            style="width: 150px; height: 150px">
                                        @else
                                            <img class="img-preview img-fluid mb-3 col-sm-5">
                                        @endif
                                            <input type="file" name="foto" class="form-control @if($errors->has('foto')) is-invalid @endif" id="img-preview" onchange="previewImg()">
                                        @if($errors->has('foto'))
